...
const skillExamples = {
  ...
  "facilitate-product-decision": ["Human decision", "Pauses material choices so people can compare real consequences and remain in control.", "Help me choose the mobile navigation direction before implementation continues.", "A decision brief with evidence, distinct options, user and delivery trade-offs, reversibility, a recommendation, and a durable DEC record.", "DEC-DESIGN-003 · D2 · DECISION REQUIRED — recommend bottom navigation for four frequent destinations; wait for the human choice."],
