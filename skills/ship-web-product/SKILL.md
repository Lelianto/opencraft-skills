...
2. Select a delivery mode from [references/delivery-modes.md](references/delivery-modes.md) and persist proportional artifacts under `.product/` when the repository uses the provided contract.
